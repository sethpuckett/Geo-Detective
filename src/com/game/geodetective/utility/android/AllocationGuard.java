...
public class AllocationGuard {
	protected static StringBuffer _tag = new StringBuffer("AllocationGuard");
    public static boolean sGuardActive = false;
    public AllocationGuard() {
        if (sGuardActive) {
        	//IllegalAllocationException e = new IllegalAllocationException("allocation guard is active");
        	//Logger.e(_tag, "illegal allocation", e);
        	//throw e;         
        }
    }
}
